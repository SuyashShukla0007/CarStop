  ...
  return (
    <div id="box">
      <ul id="head">
        ...
        <NavLink
          to="/rent"
          className={`navi ${act == "rent" ? "text-red font-bold" : ""}`}
        >
          Rent Car
        </NavLink>
        <NavLink
          to="/sell"
          className={`navi ${act == "sell" ? "text-red font-bold" : ""}`}
        >
          Sell Car
        </NavLink>
        <NavLink
          to="/buy"
          className={`navi ${act == "buy" ? "text-red font-bold" : ""}`}
        >
          Buy Car
        </NavLink>
        {!show ? (
          ...
          <h1
            className="text-lg bg-red px-3 py-2 cursor-pointer w-[120px] text-center rounded font-bold"
