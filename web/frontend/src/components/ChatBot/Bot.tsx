...
const lastmsg = useRef<HTMLDivElement>(null);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div className="h-[60vh] w-[90vw] sm:h-[70vh] md:w-[30vw] sm:w-[30vw] rounded-lg shadow-lg bg-white overflow-hidden" style={{backgroundImage:`url(${img2})`, backgroundSize:'cover', backgroundPosition:'center'}}>
